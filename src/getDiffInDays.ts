 ...
 * @example
 * getDiffInDays(new Date('2021-12-30T23:59:59'), new Date('2022-01-01T00:00:00')) //=> -1
 * getDiffInDays(new Date('2021-01-01T00:00:00'), new Date('2022-01-01T23:59:59'), true) //=> 365
 */
